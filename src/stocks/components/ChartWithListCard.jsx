...
import { Stack, Paper, Typography, List, useTheme, useMediaQuery } from '@mui/material';
...
const ChartWithListCard = (props) => {
  ...
  return (
    <Paper elevation={8} sx={{width: width, height:{xs:'fit-content'}, 
    display: 'flex', flexDirection: {xs: 'column' , md: 'row'}}} 
      justifyContent='space-between'>
      <Stack width={{xs:'100%',md:'50%'}} height='100%' spacing={3} sx={{p: '32px 32px 0 32px', boxSizing: 'border-box'}}>
      ...
      p={{xs:'32px',md:0}}
      height='100%' pr={{md:'32px'}} sx={{zIndex:6, boxSizing: 'border-box'}} alignItems='flex-end'>
        <PieChart 
